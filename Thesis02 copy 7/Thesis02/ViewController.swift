...
class ViewController: UIViewController, ARSCNViewDelegate,MGLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "mapbox://styles/ssey10/cjfhc7nt0aygc2rqgzu66xa13")
...
//            print(item.coordinates)
        ...
        let ARCameraBtn = UIButton(frame: CGRect(x:140, y: 580, width: 98, height: 64))
        ARCameraBtn.setImage(UIImage(named: "ARBtn"), for: UIControlState.normal)
